from mojo_stdlib.datetime import datetime, datetime_min, timedelta, datetime_now, datetime_max
...
def assert_is_equal(a: datetime, b: PythonObject):
    ...
    if a_repr != b_repr:
        raise Error("object " + a.__repr__() + " not equal to " + b.__repr__().to_string())
